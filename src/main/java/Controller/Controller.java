...
public class Controller {
    ...
    public boolean createUser(String userName, String password, String birthDate, String firstName, String lastName, String city, String phone, boolean b) {
        try {
            vacation4UManager.createUser(userName, password, birthDate, firstName, lastName, city, phone, b);
            return true;
        }catch (Exception e){
            return false;
        }
    ...
    public String getUserContactInformation(User userName) {
        return userName.getPhoneNumber();
    }

    public void setVacationBuyer(Vacation vacationToBuy, String userName) {
        vacationToBuy.toString();
        userName.toString();
    }
}
